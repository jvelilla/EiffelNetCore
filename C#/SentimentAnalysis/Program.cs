...
public class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        MLContextFacade mlContextFacade = new MLContextFacade(mlContext);
    ...
    private static void UseModelWithBatchItems(MLContextFacade mlContextFacade, ITransformer model)
    {
        ...
        IEnumerable<SentimentPrediction> predictedResults = mlContextFacade.CreateEnumerable(batchPredictions);
        Console.WriteLine();
